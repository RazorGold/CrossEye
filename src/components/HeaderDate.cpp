...
bool formatHeaderDate(char* buf, const size_t len) {
  ...
  // CrossInk tracks a separate clockDateHasBeenSynced flag; CrossPoint has a single
  // clockHasBeenSynced covering the whole RTC sync, which is the same guarantee here.
